...
and the [Computational Design Lab](https://www.cs.columbia.edu/~chilton/), where
I’m exploring human-centered, agentic productivity tools with a focus on
transparency and preserving user agency when working with AI. I’m also working
with Prof. [Zhuo Zhang](https://zzhang.xyz/) on vision-language models and GUI
testing agents to help uncover risky or malicious UI flows in mobile
applications.
...
Wyss-Gallifent](https://www.cs.umd.edu/people/immortal) (Principal Lecturer) and
...
I’m grateful to my professors for their support throughout my journey, including
